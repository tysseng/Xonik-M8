  ...
  return {
    ...
    onFileSaveClick: (filename, folderId, fileId) => {
      ...
      $.ajax({
        ...
        data: JSON.stringify({filename, folderId, fileId, customData: ownProps.customData}),
        dataType:'json',
    ...
    onFileLoadClick: (filename, folderId, fileId, version) => {
      $.ajax({
        ...
        type: 'POST',
        contentType:'application/json',
        data: JSON.stringify({filename, folderId, fileId, version, customData: ownProps.customData}),
        dataType:'json',
        success: function(response) {
          dispatch(toggleFileDialog(false));
        },
