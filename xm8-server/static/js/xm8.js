...
},{"./datatypes.js":161}],161:[function(require,module,exports){
datatypes = {
	CTRL_8_BIT: 0,
	CTRL_16_BIT: 1
};
...
ReactDOM.render(React.createElement(Knob, { controllerId: 'volume' }), document.getElementById('content'));
...
},{"./components/Knob.jsx":163,"./eventDebug.js":165,"./wsclient.js":167,"react-dom":3}],163:[function(require,module,exports){
...
var Knob = React.createClass({
  ...
  handleMouseMove: function (e) {
    ...
    events.controls.output.publish(new CustomEvent("controller", { detail: { id: this.props.controllerId, value: tmp } }));
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement("div", { className: "top", style: {
...
},{"../eventbusses.js":166,"react":159}],164:[function(require,module,exports){
var config = {
...
},{"./eventbusses.js":166}],166:[function(require,module,exports){
$ = require('jquery');
...
},{"jquery":2}],167:[function(require,module,exports){
var events = require("./eventbusses.js");
...
function wsConnect() {
  if ("WebSocket" in window) {
    ...
    ws.onmessage = function (event) {
      ...
      events.controls.input.publish(new CustomEvent(message.id, { detail: message.value }));
    };
  } else {
...
},{"../../shared/controllerSetup.js":160,"./config.js":164,"./eventbusses.js":166}]},{},[162]);
