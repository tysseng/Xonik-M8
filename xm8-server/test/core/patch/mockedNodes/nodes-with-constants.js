...
let node0 = sum();
param(node0, '1', paramTypesMap.CONSTANT, '3', unitsById.PERCENTAGE);

let node1 = sum();
param(node1, '0', paramTypesMap.CONSTANT, '1', unitsById.PERCENTAGE);
param(node1, '1', paramTypesMap.CONSTANT, '2', unitsById.PERCENTAGE);
link(node1, node0, '0');
