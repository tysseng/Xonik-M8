...
var nodeTypes = {
  ...
  BUFFER_PARAMETER: {
    ...
    description: "Buffer a value for the entire duration of the matrix calculation cycle. Use this if an input must be guaranteed to be the same for all nodes during a cycle",
    hasVariableParamsLength: false,   
    params: []
  },
  OUTPUT: {
