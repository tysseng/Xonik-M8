...
void TM_setupTestMatrix(){
    ...
    aNode2[NODE_PARAM_0_LO] = 4; //20
    aNode2[NODE_PARAM_0_HI] = 0;
    aNode2[NODE_PARAM_1_LO] = 1; // 5
    aNode2[NODE_PARAM_1_HI] = 0;
    aNode2[NODE_PARAM_2_LO] = 1;
    aNode2[NODE_PARAM_2_HI] = 0;
    aNode2[NODE_PARAM_3_LO] = 0x00;
    aNode2[NODE_PARAM_3_HI] = 0x7D;
    aNode2[NODE_PARAM_4_LO] = 0x00;
    aNode2[NODE_PARAM_4_HI] = 0x83;
